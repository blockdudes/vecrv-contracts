...
module.exports = async function (deployer, network, accounts) {
  ...
  // vetoken
  addContract("system", "idle", idle.address);
  addContract("system", "idleVoterProxy", voter.address);
  ...
  addContract("system", "idleBooster", booster.address);
  ...
  addContract("system", "ve3IDLE", ve3Token.address);
